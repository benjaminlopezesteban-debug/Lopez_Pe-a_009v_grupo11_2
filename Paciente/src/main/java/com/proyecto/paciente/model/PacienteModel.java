package com.proyecto.paciente.model;
...
public class PacienteModel {
    ...
    public String getNumRut() { return numRut; }
    public void setNumRut(String numRut) { this.numRut = numRut; }
    ...
    public void setFechaNaci(LocalDate fechaNaci) { this.fechaNaci = fechaNaci; }
